...
"""
Physics constants, experimental apparatus parameters, 
and default parameters for the J/psi simulation.
All energies are in GeV, cross sections in nb, 
...
N_ESCAN_POINTS = int(1e4)                           # Number of energy grid points
